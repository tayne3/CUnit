...
# | CUNIT_BUILD_DEBUG         | Always (Derived)    | ON (for Debug, RelWithDebInfo), OFF otherwise | Internal flag for debug builds.                               |
...
# | CUNIT_BUILD_DEBUG         | 总是 (派生)         | ON (对应 Debug, RelWithDebInfo), OFF (其他)   | 内部标志，用于调试构建。                                      |
...
if(CUNIT_BUILD_SHARED)
    ...
    set(CUNIT_LIB_NAME shared)
else()
    set(CUNIT_LIB_TYPE STATIC)
    set(CUNIT_LIB_NAME static)
endif()
